  ...
  <div class="food" v-show="showFlag" ref="foodd">
      <div class="food-content">
          ...
          <div class="content">
            ...
            <ratingselect :selectType="selectType" :onlyContent="onlyContent" :desc="desc" :ratings="food.ratings" @onlyContent="changeSelectType" @ratingtypeSelect="changeRatingType"></ratingselect>
